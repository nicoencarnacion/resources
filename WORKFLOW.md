...
I got the inspiration from the 5-day Design Sprint but since I usually work with very small teams, this process can last for more than 5 days.
### Map
...
- Create wireframes using Sketch and [InVision](https://www.invisionapp.com/) or [Marvel](https://marvelapp.com/) to establish the flow of the app.
- Work on your UI's [microcopy](https://material.io/guidelines/style/writing.html).
### Decide
- Produce design studies.
### Visualize
- Visual design. Set up your project's styleguide using Craft.
### Prototype
...
- Use Craft's Style plugin to easily change text styles and colors later on. It is important to setup your library first before it gets too big to manage.
